...
| Tipo | Estados |
|------|---------|
| DEMANDA_CIVIL / DEMANDA_LABORAL (parte demandada) | ASIGNADO → INICIO → TRABA_LITIS → PRUEBA → ALEGATO → SENTENCIA_1_FAV / SENTENCIA_1_DESFAV → APELACION → SENTENCIA_2_FAV / SENTENCIA_2_DESFAV → REF → EJECUCION_SENTENCIA → FINALIZADO (Recurso de Queja: eliminado por completo, ya no existe como nodo ni como trámite paralelo) |
