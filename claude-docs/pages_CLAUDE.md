...
| `NovedadesPJN/` | /novedades-judiciales (redirect desde /novedades-pjn) | ABOGADO, COORDINADOR, REFERENTE (no ADMINISTRATIVO) | ✓ bandeja "Novedades judiciales" — solapas PJN/MEV (MEV en estado vacío, prototipo) — ver `NOVEDADES_PJN_CLAUDE.md` |
