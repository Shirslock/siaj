...
export const NOTIFICACIONES_MOCK: Notificacion[] = [
  ...
  },
  {
    ...
    caratula: 'COBRO DE CANON — PERMISIONARIO XYZ',
    numeroCausa: null,
    leida: false,
    fecha: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(),
    destinatarioId: 'UR_007',
  },
  {
    id: 'NOTIF_003',
    tipo: 'REASIGNACION',
