...
// Fechas relativas a "hoy" para que el mock no envejezca: la demo siempre debe
// mostrar novedades mayormente vigentes/próximas, con a lo sumo 1-2 vencidas
// (ver `esNovedadVencida` en utils/pjnVencimiento.ts — vence a los 7 días de detectada).
...
const PJN_NOVEDADES_RAW: Omit<NovedadPJN, 'origen_organismo'>[] = [
  ...
  // PJN_001 queda deliberadamente vencida (pendiente + >7 días) — es 1 de las 2 vencidas del mock.
  { id: 'PJN_001', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_A',
    fecha_deteccion: hace(9), fecha_movimiento: hace(10), row_index: 1,
  ...
  { id: 'PJN_002', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_A',
    fecha_deteccion: hace(3), fecha_movimiento: hace(4), row_index: 2,
    oficina: 'ISJ', tipo: 'CEDULA ELECTRONICA PARTE',
  ...
  { id: 'PJN_003', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_A',
    fecha_deteccion: hace(3), fecha_movimiento: hace(4), row_index: 3,
    oficina: 'ISJ', tipo: 'MOVIMIENTO', detalle: 'EN LETRA',
    estado: 'descartada', aplicada_por: 'UR_004', fecha_aplicacion: hace(3) },
  { id: 'PJN_004', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_A',
    fecha_deteccion: hace(3), fecha_movimiento: hace(4), row_index: 4,
    oficina: 'ISJ', tipo: 'FIRMA DESPACHO',
    detalle: 'AUTOS PARA ALEGAR (EXPEDIENTE DIGITAL)', foja: '254/254',
    estado: 'aplicada', aplicada_por: 'UR_004', fecha_aplicacion: hace(3) },
  { id: 'PJN_005', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_A',
    fecha_deteccion: hace(3), fecha_movimiento: hace(4), row_index: 5,
  ...
  // ── C-0100/2026 (CIVIL) — corrida reciente, detecta movimientos de hace ~2/3 días ──
  ...
  { id: 'PJN_006', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 1,
    oficina: 'ISJ', tipo: 'MOVIMIENTO', detalle: 'EN DESPACHO', estado: 'pendiente' },
  { id: 'PJN_007', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 2,
    oficina: 'ISJ', tipo: 'MOVIMIENTO', detalle: 'EN LETRA', estado: 'pendiente' },
  { id: 'PJN_008', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 3,
    ...
    estado: 'pendiente' },
  { id: 'PJN_009', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 4,
    oficina: 'ISJ', tipo: 'CEDULA ELECTRONICA TRIBUNAL',
    detalle: 'CEDULA N° 26000109795789 - NOTIFICADO EL DIA: 27/08/2026 09:57',
    estado: 'pendiente' },
  { id: 'PJN_010', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 5,
    oficina: 'ISJ', tipo: 'EVENTO', detalle: 'NOTIFICACION', estado: 'pendiente' },
  { id: 'PJN_011', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 6,
    oficina: 'ISJ', tipo: 'CAMBIO DE ESTADO DE EXPEDIENTE',
    detalle: 'APERTURA RECURSO - RELACION', estado: 'pendiente' },
  { id: 'PJN_012', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 7,
    oficina: 'ISJ', tipo: 'FIRMA DESPACHO',
    detalle: 'POR RECIBIDOS. DEL RECURSO DE INCONSTITUCIONALIDAD INTERPUESTO CORRASE TRASLADO.',
    foja: '562/562', estado: 'pendiente' },
  { id: 'PJN_013', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 8,
    oficina: 'ISJ', tipo: 'DEO',
    detalle: 'ENVIO DEO: 23999755 - REMISIÓN DE AUTOS PRINCIPALES - JUZGADO CIVIL 99',
    estado: 'pendiente' },
  { id: 'PJN_014', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 9,
    oficina: 'ISJ', tipo: 'RECEPCION PASE', detalle: 'CAMARA CIVIL - SALA J',
    estado: 'pendiente' },
  { id: 'PJN_015', expediente_id: 'C-0100/2026', corrida_id: 'RUN_C0100_B',
    fecha_deteccion: hace(2), fecha_movimiento: hace(3), row_index: 10,
    oficina: '032', tipo: 'PASE', detalle: 'CAMARA CIVIL - SALA J',
    estado: 'pendiente' },

  // ── L-0100/2026 (LABORAL) — corrida reciente, ilustrativa ──
  { id: 'PJN_016', expediente_id: 'L-0100/2026', corrida_id: 'RUN_L0100_A',
    fecha_deteccion: hace(1), fecha_movimiento: hace(2), row_index: 1,
    oficina: 'SEC30', tipo: 'MOVIMIENTO', detalle: 'EN DESPACHO', estado: 'pendiente' },
  { id: 'PJN_017', expediente_id: 'L-0100/2026', corrida_id: 'RUN_L0100_A',
    fecha_deteccion: hace(1), fecha_movimiento: hace(2), row_index: 2,
  ...
  { id: 'PJN_018', expediente_id: 'L-0100/2026', corrida_id: 'RUN_L0100_A',
    fecha_deteccion: hace(1), fecha_movimiento: hace(2), row_index: 3,
  ...
  { id: 'PJN_019', expediente_id: 'L-0100/2026', corrida_id: 'RUN_L0100_A',
    fecha_deteccion: hace(1), fecha_movimiento: hace(2), row_index: 4,
  ...
  { id: 'PJN_020', expediente_id: 'L-0100/2026', corrida_id: 'RUN_L0100_A',
    fecha_deteccion: hace(1), fecha_movimiento: hace(2), row_index: 5,
    oficina: 'SEC30', tipo: 'MOVIMIENTO', detalle: 'EN LETRA', estado: 'pendiente' },

  // ── P-0100/2026 (PENAL) — corrida ilustrativa ──
  // PJN_021 queda deliberadamente vencida (pendiente + >7 días) — es la 2da de las 2 vencidas del mock.
  { id: 'PJN_021', expediente_id: 'P-0100/2026', corrida_id: 'RUN_P0100_A',
    fecha_deteccion: hace(8), fecha_movimiento: hace(9), row_index: 1,
    oficina: 'JCC22', tipo: 'MOVIMIENTO', detalle: 'EN DESPACHO', estado: 'pendiente' },
  { id: 'PJN_022', expediente_id: 'P-0100/2026', corrida_id: 'RUN_P0100_A',
    fecha_deteccion: hace(4), fecha_movimiento: hace(5), row_index: 2,
  ...
  { id: 'PJN_023', expediente_id: 'P-0100/2026', corrida_id: 'RUN_P0100_A',
    fecha_deteccion: hace(4), fecha_movimiento: hace(5), row_index: 3,
    oficina: 'JCC22', tipo: 'DEO',
    detalle: 'ENVIO DEO: 88123456 - OFICIO COMISARÍA 25° - CABA', estado: 'pendiente' },
  { id: 'PJN_024', expediente_id: 'P-0100/2026', corrida_id: 'RUN_P0100_A',
    fecha_deteccion: hace(4), fecha_movimiento: hace(5), row_index: 4,
    oficina: 'JCC22', tipo: 'CEDULA ELECTRONICA TRIBUNAL',
    detalle: 'CEDULA N° 26000113345501 - NOTIFICADO EL DIA: 29/08/2026 11:30',
    estado: 'pendiente' },
  { id: 'PJN_025', expediente_id: 'P-0100/2026', corrida_id: 'RUN_P0100_A',
    fecha_deteccion: hace(4), fecha_movimiento: hace(5), row_index: 5,
