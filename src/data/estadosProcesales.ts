...
export const ESTADOS_LANZAMIENTO_JUDICIALIZADO: EstadoProcesal[] = [
  { codigo: 'ASIGNADO', label: 'Asignado', siguiente: 'INICIO', tareas: [] },
  {
    ...
    tareas: [
      t('LJ_INI_01', 'Análisis inicial del inmueble y antecedentes'),
      t('LJ_INI_02', 'Verificar competencia territorial'), t('LJ_INI_03', 'Preparar escrito de lanzamiento'),
      t('LJ_INI_04', 'Adjuntar documental'), t('LJ_INI_05', 'Presentación judicial'),
      t('LJ_INI_06', 'Control de cargo judicial'), t('LJ_INI_07', 'Notificación a los ocupantes'),
      t('LJ_INI_08', 'Coordinar con fuerzas de seguridad si corresponde'),
      t('LJ_INI_09', 'Control de plazos'), t('LJ_INI_10', 'Seguimiento de resolución de lanzamiento'),
      t('LJ_INI_11', 'Impulso procesal'),
    ],
  },
  {
    ...
    siguiente: 'SENTENCIA_2_FAV',
    tareas: [
      t('LJ_SL_01', 'Análisis de resolución'), t('LJ_SL_02', 'Coordinar ejecución del lanzamiento'),
      t('LJ_SL_03', 'Registrar resultado del lanzamiento'), t('LJ_SL_04', 'Notificar a área requirente'),
      t('LJ_SL_05', 'Control de recursos de la contraparte'), t('LJ_SL_06', 'Evaluar apelación si corresponde'),
    ],
  },
  {
    codigo: 'SENTENCIA_2_FAV',
    ...
    siguiente: 'FINALIZADO',
    tareas: [
      t('LJ_S2F_01', 'Análisis de sentencia de cámara'), t('LJ_S2F_02', 'Ejecutar lanzamiento definitivo'),
      t('LJ_S2F_03', 'Notificar a área requirente'),
    ],
  },
  {
    codigo: 'SENTENCIA_2_DESFAV',
    ...
    siguiente: 'REF',
    tareas: [
      t('LJ_S2D_01', 'Análisis de sentencia'), t('LJ_S2D_02', 'Evaluar recurso extraordinario'),
      t('LJ_S2D_03', 'Notificar a área requirente'), t('LJ_S2D_04', 'Redacción de REF'),
    ],
  },
  {
    codigo: 'REF',
    ...
    siguiente: 'FINALIZADO',
    tareas: [
      t('LJ_REF_01', 'Redacción de REF'), t('LJ_REF_02', 'Presentación de REF'),
      t('LJ_REF_03', 'Control de admisibilidad'), t('LJ_REF_04', 'Seguimiento de CSJN'),
      t('LJ_REF_05', 'Registrar resultado'),
    ],
  },
  {
    codigo: 'FINALIZADO',
    ...
    esArchivado: true,
    tareas: [
      t('LJ_FIN_01', 'Archivo del expediente'), t('LJ_FIN_02', 'Notificación final a área requirente'),
      t('LJ_FIN_03', 'Registrar resultado'), t('LJ_FIN_04', 'Cierre en sistema'),
      t('LJ_FIN_05', 'Devolver inmueble al área requirente'),
    ],
  },
]
