...
export const FORMULARIOS: Record<string, FormularioSubtipo> = {
  OFICIO: {
    ...
    mesa: [
      ...
      { id:'mesa_tribunal',       label:'Tribunal',                 type:'juzgado_filtered' },
  ...
  CARTA_DOC: {
    ...
    abogado: [
      ...
      { id:'abg_monto_reclam_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
  ...
  MEDIACION: {
    ...
    abogado: [
      ...
      { id:'monto_acuerdo_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
      ...
      { id:'abg_monto_reclamado_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
  ...
  BENEFICIO_LITIGAR: {
    ...
    mesa: [
      { id:'juzgado_fuero', label:'Fuero', type:'fuero_select' },
      { id:'juzgado',                   label:'Juzgado',                        type:'juzgado_filtered' },
      { id:'mesa_caratula',             label:'Carátula',                       type:'text',   full:true },
      { id:'mesa_secretaria',           label:'Secretaría',                     type:'secretaria_juzgado', juzgadoRef:'juzgado' },
  ...
  COBRO_CANON: {
    ...
    abogado: [
      ...
      { id:'monto_informado_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
      { id:'monto_actualizado',  label:'Monto actualizado',               type:'money' },
      { id:'monto_actualizado_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
  ...
  RECLAMO_CONTRAT: {
    ...
    abogado: [
      ...
      { id:'monto_reclamar_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
    ],
  },
  ...
  RECUPERO: {
    ...
    abogado: [
      ...
      { id:'abg_monto_reclamar_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
      { id:'abg_documental',     label:'Documental',       type:'select', options:['Completo','Incompleto'] },
    ],
  },
  ...
  CONSIGNACION: {
    ...
    abogado: [
      ...
      { id:'abg_monto_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
  ...
  EJECUCION_GAR: {
    ...
    abogado: [
      ...
      { id:'abg_monto_ejecutar_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
  ...
  QUERELLA: {
    ...
    mesa: [
      ...
      { id:'tribunal',        label:'Tribunal',          type:'juzgado_filtered' },
  ...
  DEFENSA_CIVIL: {
    ...
    mesa: [
      ...
      { id:'monto_reclamado_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
    ],
    abogado: [
  ...
  DEFENSA_PENAL: {
    ...
    abogado: [
      ...
      { id:'abg_juzgado_fuero', label:'Fuero', type:'fuero_select' },
      { id:'abg_juzgado',         label:'Juzgado',                  type:'juzgado_filtered' },
      { id:'abg_fiscalia',        label:'Fiscalía',                 type:'juzgado' },
      { id:'abg_tribunal',        label:'Tribunal',                 type:'juzgado_filtered' },
  ...
  PEDIDO_CAUSA_PENAL: {
    ...
    mesa: [
      ...
      { id:'fiscalia',     label:'Fiscalía',            type:'juzgado' },
      { id:'tribunal_fuero', label:'Fuero (Tribunal)', type:'fuero_select' },
      { id:'tribunal',     label:'Tribunal',            type:'juzgado_filtered' },
      { id:'ufi',          label:'UFI',                 type:'juzgado' },
  ...
  DEMANDA_CIVIL: {
    ...
    mesa: [
      ...
      { id:'mesa_monto_moneda', label:'Tipo de moneda', type:'select', options:[{ value:'ARS', label:'ARS — Pesos argentinos' }, { value:'USD', label:'USD — Dólares' }, { value:'EUR', label:'EUR — Euros' }] },
    ],
    abogado: [
  ...
  OTRAS: {
    ...
    mesa: [
      ...
      { id:'juzgado_fuero', label:'Fuero', type:'fuero_select' },
      { id:'juzgado',          label:'Juzgado / Organismo (si aplica)',  type:'juzgado_filtered' },
