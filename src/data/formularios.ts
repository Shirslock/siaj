...
export const FORMULARIOS: Record<string, FormularioSubtipo> = {
  ...
  CARTA_DOC: {
    ...
    abogado: [
      { id:'abg_monto_reclam',   label:'Monto reclamado',                       type:'money_multi' },
  ...
  COBRO_CANON: {
    ...
    abogado: [
      ...
      { id:'monto_informado',    label:'Monto informado',                 type:'money_multi' },
      { id:'monto_actualizado',  label:'Monto actualizado',               type:'money_multi' },
  ...
  RECLAMO_CONTRAT: {
    ...
    abogado: [
      ...
      { id:'monto_reclamar',     label:'Monto a reclamar',                type:'money_multi' },
    ],
  },
  ...
  RECUPERO: {
    ...
    abogado: [
      ...
      { id:'abg_monto_reclamar', label:'Monto a reclamar', type:'money_multi' },
      { id:'abg_documental',     label:'Documental',       type:'select', options:['Completo','Incompleto'] },
    ],
  },
  ...
  CONSIGNACION: {
    ...
    abogado: [
      ...
      { id:'abg_monto',         label:'Monto a consignar',                   type:'money_multi' },
  ...
  EJECUCION_GAR: {
    ...
    abogado: [
      ...
      { id:'abg_monto_ejecutar',     label:'Monto/s a ejecutar',            type:'money_multi' },
  ...
  DEFENSA_CIVIL: {
    ...
    mesa: [
      ...
      { id:'monto_reclamado',       label:'Monto Reclamado',             type:'money_multi' },
    ],
    abogado: [
