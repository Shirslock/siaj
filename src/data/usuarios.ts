...
export const USUARIOS: Usuario[] = [
  ...
  { id:'UR_004', apellido:'CASANO',          nombre:'FELIX',         rolBD:'abogado',             roles:['abogado'],                             rolSistema: mapRol('abogado'),             areas:['CIVIL'],                      fifoOrder:{ CIVIL:2 }, cuil:'20-27654321-3', email:'felix.casano@trenesargentinos.gob.ar', matriculas:{ CABA:{ tomo:'120', folio:'45' }, FEDERAL:{ tomo:'12', folio:'891' } }, activo: true },
  ...
  { id:'UR_013', apellido:'PISANO',          nombre:'PABLO',         rolBD:'abogado_coordinador', roles:['abogado_coordinador'],                 rolSistema: mapRol('abogado_coordinador'), areas:['CIVIL','LABORAL'],            email:'pablo.pisano@trenesargentinos.gob.ar', matriculas:{ CABA:{ tomo:'41', folio:'102' }, PROVINCIA:{ tomo:'8', folio:'774' }, FEDERAL:{ tomo:'9', folio:'203' } }, activo: true },
...
export const ROL_ACCESOS: Record<RolSistema, AccesosRol> = {
  REFERENTE: {
    nav: ['dashboard', 'home', 'actuaciones', 'novedades_judiciales', 'boga', 'agenda', 'tareas', 'licencias', 'configuracion'],
    puedeReasignar: false,
    verTodaBandeja: true,
    inicio: '/dashboard',
  },
  COORDINADOR: {
    nav: ['dashboard', 'home', 'actuaciones', 'novedades_judiciales', 'boga', 'agenda', 'tareas', 'licencias'],
    puedeReasignar: false,
    verTodaBandeja: true,
    inicio: '/actuaciones',
  },
  ABOGADO: {
    nav: ['home', 'actuaciones', 'novedades_judiciales', 'boga', 'agenda', 'tareas', 'licencias'],
    puedeReasignar: false,
