...
export const EXPEDIENTE_DEMANDA_VENCIMIENTO_MOCK: Expediente = {
  ...
  caratula: 'GOMEZ CARLOS ALBERTO C/ SOFSA SA S/ DAÑOS Y PERJUICIOS',
  numero_ee_gde: 'EX-2026-22222-APN-DGJYA',
  numero_causa: '7821/2026',
  juzgado: 'JUZ_003',
  abogado_id: 'UR_004',
  es_juicio_iniciado: true,
  fecha_inicio_juicio: '2025-12-01',
  fecha_ultimo_impulsorio: '2026-03-25',
  fecha_recepcion: '2025-11-20',
  campos_mesa: {
    mesa_num_causa:  '7821/2026',
    mesa_juzgado:    'JUZ_003',
    mesa_caratula:   'GOMEZ CARLOS ALBERTO C/ SOFSA SA S/ DAÑOS Y PERJUICIOS',
  ...
  timeline: [
    ...
    },
    {
      ...
      descripcion: 'Estado avanzado por CASANO Felix.',
      fecha: '2025-11-25',
      id: 'DC26_MOV_01',
      expediente_id: 'C-0026/2026',
      activo: true,
    ...
    },
    {
      ...
      titulo: 'Impulso procesal — presentación de prueba documental',
      descripcion: 'Movimiento impulsorio registrado.',
      fecha: '2026-03-25',
      id: 'DC26_IMP_01',
      expediente_id: 'C-0026/2026',
      activo: true,
